...
if(comprobarVacio($_POST["terminos"])){
    header("location:/index.php?error=aceptar&campo=terminos&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;
}else{
...
// Vacio
if(!isset($respUser)){
    header("location:/index.php?error=vacio&campo=captcha&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;
}
// No coinciden
if($respUser != $respSystem){
    header("location:/index.php?error=nocoincide&campo=captcha&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;
}
...
if(comprobarCaracteres($nombre, 3, 40)){
    header("location:/index.php?error=caracteres&campo=nombre&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;
}
...
if(comprobarVacio($mensaje)){
    header("location:/index.php?error=vacio&campo=mensaje&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;
}
// Si nombre es menor de 4 o mayor de 200
if(comprobarCaracteres($mensaje, 5, 200)){
    header("location:/index.php?error=caracteres&campo=mensaje&nombre=$nombre&telefono=$telefono&email=$email&mensaje=$mensaje");
    die;    
}
